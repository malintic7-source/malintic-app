...
void main() {
  ...
  group('Authentication & First-Login Password Change Flow', () {
    ...
    test(
      'First login password change updates credentials and triggers clean auto-logout',
      () async {
        ...
        final loggedInUser = await auth.loginWithEmail(
          'stagiaire.test@malintic.ml',
          '00000000',
        );
        ...
        expect(
          () async => await auth.loginWithEmail(
            'stagiaire.test@malintic.ml',
            '00000000',
          ),
          throwsException,
        ...
        final reconnectedUser = await auth.loginWithEmail(
          'stagiaire.test@malintic.ml',
          'MonSuperMotDePasse2026!',
        );

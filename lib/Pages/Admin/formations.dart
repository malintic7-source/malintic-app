...
class _AdminFormationsState extends State<AdminFormations>
        ...
        return StreamBuilder<List<Formation>>(
          ...
          builder: (context, formSnap) {
            ...
            for (final f in formations) {
              final enrolled = learners
                  .where(
                    (u) => u.assignedFormations.any(
              ...
              totalCapacity +=
                  f.capaciteMax ??
                  (enrolled.length > 15 ? enrolled.length : 15);
              for (final u in enrolled) {
                final c = _db.getStudentCohort(
                  studentId: u.id,
                  formationId: f.id,
                );
  ...
  Widget _buildFormationProfitabilityAndCohorts(Formation formation) {
    ...
    final capacity =
        ...
        (enrolledStudents.length > 15 ? enrolledStudents.length : 15);
    final fillRate = capacity > 0
        ? (enrolledStudents.length / capacity).clamp(0.0, 1.0)
        : 0.0;
    ...
    final collected = payments
        .where(
          (p) =>
              p.status == PaymentStatus.effectue &&
              (p.formationId == formation.id ||
                  studentIds.contains(p.etudiantId) ||
                  studentIds.contains(p.apprenantId)),
        )
        .fold<double>(0.0, (sum, p) => sum + p.montant);
    ...
    for (final s in enrolledStudents) {
      final cohort =
          _db.getStudentCohort(studentId: s.id, formationId: formation.id) ??
          'Non assigné';
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildFinMiniMetric(
                'Encaissé',
                '${collected.toStringAsFixed(0)} F',
                const Color(0xFF166534),
                const Color(0xFFDCFCE7),
              ),
              _buildFinMiniMetric(
                'Attendu',
                '${expectedTotal.toStringAsFixed(0)} F',
                const Color(0xFF1E293B),
                const Color(0xFFF1F5F9),
              ),
              _buildFinMiniMetric(
                'Reste Dû',
                '${remaining.toStringAsFixed(0)} F',
          ...
          Row(
            ...
            children: [
              ...
              Row(
                children: [
                  InkWell(
                    onTap: () => ExportAccountingDialog.show(
                      context,
                  ...
                  InkWell(
                    onTap: () =>
                        _showCohortsManagementDialog(context, formation),
                    child: Text(
                      'Gérer les cohortes >',
                      style: GoogleFonts.poppins(
                        fontSize: 10.5,
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setModalState) {
          ...
          final filteredStudents = allStudents.where((s) {
            final cohort =
                _db.getStudentCohort(
                  studentId: s.id,
                  formationId: formation.id,
                ) ??
                'Non assigné';
            if (selectedCohortFilter != 'Tous' &&
                cohort != selectedCohortFilter) {
              return false;
            }
            if (searchQuery.isNotEmpty) {
              final query = searchQuery.toLowerCase();
              final matchName = '${s.prenom} ${s.nom}'.toLowerCase().contains(
                query,
              );
              final matchMatricule = (s.matricule ?? '').toLowerCase().contains(
                query,
              );
                ...
                children: [
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              isDense: true,
                              hintText:
                                  'Nouveau nom de groupe (ex: Cohorte Matin, Groupe B, Samedi)...',
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      isDense: true,
                      hintText:
                          'Rechercher un apprenant par nom ou matricule...',
                    ...
                    child: filteredStudents.isEmpty
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (context, idx) {
                              ...
                              final currentCohort = _db.getStudentCohort(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      if (formation.type == FormationType.mixte &&
                          formation.prixEnLigne != null) ...[
                        Container(
                          padding: const EdgeInsets.symmetric(
                            horizontal: 8,
                            vertical: 4,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (formation.modules.isNotEmpty ||
                            formation.modulesBonus.isNotEmpty) ...[
                          const SizedBox(height: 12),
                          ...
                          ...formation.modules.map((moduleTitle) {
                            ...
                            final formateurId =
                                formation.moduleFormateurIds[moduleTitle];
                            final formateur = formateurId != null
                                ? _db.getUserById(formateurId)
                                : null;
                            final formateurName = formateur != null
                                ? '${formateur.prenom} ${formateur.nom}'
                                : (formateurId != null && formateurId.isNotEmpty
                                      ? formateurId
                                      : 'Non assigné');
                        ...
                        Wrap(
                          ...
                          children: [
                            OutlinedButton.icon(
                              onPressed: () => _showCohortsManagementDialog(
                                context,
                                formation,
                              ),
                              icon: const Icon(
  ...
  List<Formation> _filterFormations(List<Formation> formations) {
    ...
    return formations.where((formation) {
      ...
      final matchesSearch =
          ...
          formation.modules.any(
            (module) => module.toLowerCase().contains(query),
          );
                      ...
                      setModalState(() {
                        moduleItems.add(
                          _ModuleItemData(
                            ...
                            formateurId: formateurs.isNotEmpty
                                ? formateurs.first.id
                                : null,
                            isBonus: false,
                          ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              isDense: true,
                              hintText: item.isBonus
                                  ? 'Intitulé du module bonus (ex: PowerPoint + IA)'
                                  : 'Intitulé du module (ex: Flutter & Dart)',
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(6),
                              ),
                              contentPadding: const EdgeInsets.symmetric(
                    ...
                    Row(
                      children: [
                        Expanded(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'ex: 35000',
                              helperText:
                                  'Prix pour inscription à la carte hors-SFP',
                        ...
                        Expanded(
                          ...
                          child: DropdownButtonFormField<String>(
                            initialValue:
                                (item.formateurId != null &&
                                    formateurs.any(
                                      (f) => f.id == item.formateurId,
                                    ))
                                ? item.formateurId
                                : null,
                            isDense: true,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildFormField(
                      ...
                      Icons.link_rounded,
                      helperText:
                          'Coller un lien (http...) ou utiliser le sélecteur ci-dessus',
                      onChanged: (val) {
                        setState(() {
                          uploadedImageUrl = val.trim().isEmpty
                              ? null
                              : val.trim();
                        });
                      },
                    ...
                    _buildFormField(
                      ...
                      isNumber: true,
                      helperText:
                          'Forfait fixe pour stage SFP (ex: 100000 FCFA)',
                    ),
                    if (typeValue == 'En ligne' || typeValue == 'Mixte')
                      _buildFormField(
                        ...
                        isNumber: true,
                        helperText:
                            'Forfait fixe en ligne pour SFP (ex: 125000 FCFA)',
                      ),
                    _buildFormField(
                      dureeController,
                      'Durée (semaines)',
                    ...
                    _buildFormField(
                      ...
                      Icons.timer_rounded,
                      helperText:
                          'Ex: 3 mois • 3 séances par semaine • 3h par séance',
                    ),
                    _buildFormField(
                      horairesController,
                      'Horaires',
                        ...
                        children: [
                          ...
                          if (isStage) ...[
                            ...
                            _buildFormField(
                              ...
                              isNumber: true,
                              helperText:
                                  'Ex: 3 modules pour le SFP5 (parmi tous les modules proposés)',
                            ),
                          ],
                        ],
                      ),
                    ...
                    onTap: isUploading
                        ...
                        : () async {
                            ...
                            for (final item in moduleItems) {
                              ...
                              if (item.formateurId != null &&
                                  item.formateurId!.isNotEmpty) {
                            ...
                            final prix =
                                ...
                                0.0;
                            final prixEnLigne =
                                prixEnLigneController.text.trim().isEmpty
                                ? null
                                : double.tryParse(
                                    prixEnLigneController.text.trim(),
                                  );
                            final dureeSemaines =
                            ...
                            final maxModulesParEtudiant = isStage
                                ? (int.tryParse(
                                        maxModulesController.text.trim(),
                                      ) ??
                                      3)
                                : null;
                            final dateDebut =
                                dateDebutController.text.trim().isEmpty
                                ? null
                                : _parseDate(dateDebutController.text.trim());
                            final dateFin =
                                dateFinController.text.trim().isEmpty
                                ? null
  ...
  void _showEditFormationDialog(BuildContext context, Formation formation) {
    ...
    final formateurs = _db
        ...
        .toList();
    final moduleItems = <_ModuleItemData>[
      ...formation.modules.map(
        (m) => _ModuleItemData(
          nameCtrl: TextEditingController(text: m),
          priceCtrl: TextEditingController(
            text:
                formation.modulePrices[m] != null &&
                    formation.modulePrices[m]! > 0
    ...
    final prixEnLigneController = TextEditingController(
      text: formation.prixEnLigne != null
          ? formation.prixEnLigne!.toStringAsFixed(0)
          : '',
    );
    final dureeController = TextEditingController(
    ...
    final maxModulesController = TextEditingController(
      text:
          (formation.maxModulesParEtudiant ?? (formation.estStage ? 3 : null))
              ?.toString() ??
          '',
    );
  ...
  List<Horaire> _parseHoraires(String rawHoraires) {
    ...
    return lines.map((line) {
      ...
      return Horaire(jour: line, heureDebut: '09h00', heureFin: '17h00');
    }).toList();
  }
}
